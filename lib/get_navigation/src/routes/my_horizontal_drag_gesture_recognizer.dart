...
/// See also:
///
///  * [MyHorizontalDragGestureRecognizer], for left and right drags.
///  * [MyVerticalDragGestureRecognizer], for up and down drags.
...
abstract class DragGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  /// ## Example:
  ///
  /// A [MyHorizontalDragGestureRecognizer] and a [MyVerticalDragGestureRecognizer]
  ...
  /// the [MyHorizontalDragGestureRecognizer] wins the arena. With
  ...
  /// [MyVerticalDragGestureRecognizer] or [MyHorizontalDragGestureRecognizer]),
  ...
  /// [MyVerticalDragGestureRecognizer], x-axis for the [MyHorizontalDragGestureRecognizer],
  /// and the entire plane for [PanGestureRecognizer]. The threshold for both
  /// [MyVerticalDragGestureRecognizer] and [MyHorizontalDragGestureRecognizer] are
  ...
  void handleEvent(PointerEvent event) {
    ...
    if (event is PointerCancelEvent || event is PointerPanZoomEndEvent || event is PointerUpEvent) {
      _giveUpPointer(event.pointer);
    }
...
/// See also:
///
///  * [MyHorizontalDragGestureRecognizer], for a similar recognizer but for
///    horizontal movement.
///  * [MultiDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class MyVerticalDragGestureRecognizer extends DragGestureRecognizer {
...
/// See also:
///
///  * [MyVerticalDragGestureRecognizer], for a similar recognizer but for
///    vertical movement.
///  * [MultiDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class MyHorizontalDragGestureRecognizer extends DragGestureRecognizer {
  ...
  MyHorizontalDragGestureRecognizer({
    ...
    super.supportedDevices,
    super.allowedButtonsFilter,
    this.shouldBlockFling,
  });

  /// 回调函数，用于检查是否应该阻止 fling 手势
  /// 返回 true 时会阻止 fling（例如在 PageView/TabBarView 上）
  final bool Function()? shouldBlockFling;

  @override
  bool isFlingGesture(VelocityEstimate estimate, PointerDeviceKind kind) {
    // 如果在 PageView/TabBarView 上，阻止 fling 手势
    if (shouldBlockFling?.call() == true) {
      return false;
    }
  ...
  @override
  bool _hasSufficientGlobalDistanceToAccept(PointerDeviceKind pointerDeviceKind, double? deviceTouchSlop) {
    return (_globalDistanceMoved.toInt() > 0) &&
        _globalDistanceMoved.abs() > computeHitSlop(pointerDeviceKind, gestureSettings);
  }
